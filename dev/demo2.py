...
def cast(db, context, log, fields):
    ...
    for vote in context["votes"]:
        print('DEBUG:Vote[0]:' + vote[0])
        print('DEBUG:Vote[1]:' + vote[1])
        print('DEBUG:Vote[2]:' + vote[2])
...
def inq(db, context, log, fields):
    ...
    for tup in crusherdict.CrusherDict(db,fields[1]):
        try:  #if tup and tup[0] and tup[0][0] and tup [0][1]:
...
for line in cmd:
    ...
    print(line)
    #continue
    commands[line[0]](db,context,log,line) # if return is true... hm...
    #if commands[line[0]](db,context,log,line): # if return is true... hm...
    #    break
